...
describe("Test read Configuration()", () => {
  ...
  test("readEnvironmentConfiguration() should read values from the environment", () => {
    ...
    process.env.FALLBACK_LANGUAGE = getRandomString(10);
  ...
  test("readEnvironmentConfiguration() should return default value if environment is not set", () => {
    ...
    delete process.env.FALLBACK_LANGUAGE;
    ...
    expect(config).toEqual({
      ...
      fallbackLanguage: LanguageAPISpecs.Constants.FALLBACK_LANGUAGE.shortCode,
    });
  });
});
  ...
  describe("Test getFallbackLanguage()", () => {
    ...
    test.each([
      ...
      (_description, givenValue) => {
        ...
        const expectedFallbackLanguage = LanguageAPISpecs.Constants.FALLBACK_LANGUAGE.shortCode;
