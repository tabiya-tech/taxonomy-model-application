...
export function getOccupationGroupHistoryPathParameters(
  path: string
): OccupationGroupDetailAPISpecs.Types.Param.Payload {
  return parsePath<OccupationGroupDetailAPISpecs.Types.Param.Payload>(Routes.OCCUPATION_GROUP_HISTORY_ROUTE, path);
}
