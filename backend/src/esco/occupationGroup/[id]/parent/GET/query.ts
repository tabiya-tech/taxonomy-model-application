...
export function getOccupationGroupParentPathParameters(
  path: string
): OccupationGroupDetailAPISpecs.Types.Param.Payload {
  return parsePath<OccupationGroupDetailAPISpecs.Types.Param.Payload>(Routes.OCCUPATION_GROUP_PARENT_ROUTE, path);
}
