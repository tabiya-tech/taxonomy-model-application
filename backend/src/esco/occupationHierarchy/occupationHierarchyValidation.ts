 ...
 * For more information about the rules concerning occupation hierarchy relationships, see [taxonomy_hierarchy.md](taxonomy_hierarchy.md#occupation-hierarchy)
 ...
 * For more information about the rules concerning occupation hierarchy codes, see [occupation-hierarchy.md](occupation-hierarchy.md#occupation-hierarchy)
