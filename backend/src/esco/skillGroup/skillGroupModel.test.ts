  ...
  describe("Validate skillGroup fields", () => {
    ...
    describe("Test validation of 'code'", () => {
      test.each([
        ...
        [
          ...
          "only whitespace characters",
          WHITESPACE,
          `${WHITESPACE} is not a valid code.`,
        ],
        [
          CaseType.Failure,
          "not a string od digits",
          "foo1",
          "foo1 is not a valid code.",
        ],
        [
          CaseType.Failure,
          "more than 4 digits",
          "55555",
          "55555 is not a valid code.",
        ],
        [
          CaseType.Failure,
          "with negative sign",
          "-9999",
          "-9999 is not a valid code.",
        ],
    ...
    describe("Test validation of 'altLabels'", () => {
      test.each([
        ...
        [
          CaseType.Failure,
          "not and array of array of (string)",
          [["bar"]],
          "Path `{0}` is required.",
        ],
        [
    ...
    describe("Test validation of 'parentGroups'", () => {
      test.each([
        ...
        [
          ...
          `Validator failed for path \`{0}\` with value \`${getMockId(
            2
          )},${getMockId(2)}\``,
        ],
        [
