import { ISkill, ISkillReference, ReuseLevel, SkillType } from "../_shared/skill.types";
...
import {
  transform,
  transformSkillOccupation,
  transformSkillRelated,
...
describe("test the transformation of the ISkill[] -> ISkillResponse[]", () => {
  test("should transform the ISkill[] to ISkillResponse[]", () => {
    ...
    // WHEN the transformation function is called
    const actual = transformPaginatedRelation(givenObjects, givenBasePath, limit, cursor);
