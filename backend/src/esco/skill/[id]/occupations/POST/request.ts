...
export function parseAndValidatePOSTRequest(
...
): SkillAPISpecs.Skill.Occupations.POST.Types.Request.Payload | APIGatewayProxyResult {
  ...
  let payload: SkillAPISpecs.Skill.Occupations.POST.Types.Request.Payload;
  try {
