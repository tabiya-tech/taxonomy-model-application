...
import { handler as skillChildrenHandler } from "./index";
...
describe("Test for skill children GET handler with a DB", () => {
  let dbConnection: Connection | undefined;
  beforeAll(async () => {
    const config = getTestConfiguration("SkillChildrenHandlerTestDB");
  ...
  test("GET /models/{modelId}/skills/{id}/children should return children", async () => {
    ...
    // @ts-ignore
    const response = await skillChildrenHandler(event);
