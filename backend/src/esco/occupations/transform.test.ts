...
import {
  ...
  getIOccupationMockDataWithOccupationGroupChildren,
...
describe("test the transformation of IOccupation[] -> IOccupationResponse[]", () => {
  test("should transform paginated IOccupation[] correctly", () => {
    const givenObjects: IOccupation[] = [
      getIOccupationMockData(),
      getIOccupationMockDataWithOccupationGroupChildren(),
      getIOccupationMockDataWithOccupationChildren(),
    ];
    ...
    expect(actual).toEqual({
      items: givenObjectsPaginated.map((obj) =>
        expect.objectContaining({
          id: obj.id,
          UUID: obj.UUID,
...
describe("test the transformation of parent and children objectType fields in IOccupationResponse", () => {
  test("should transform parent = ESCOOccupation", () => {
    ...
    expect(actual.parent!.objectType).toBe(OccupationAPISpecs.Enums.ObjectTypes.ESCOOccupation);
  });
  ...
  test("should transform parent = ISCOGroup", () => {
    ...
    expect(actual.parent!.objectType).toBe(OccupationAPISpecs.Enums.ObjectTypes.ISCOGroup);
  });

  test("should transform children with objectType = ISCOGroup", () => {
    const givenObject = getIOccupationMockDataWithOccupationGroupChildren();
    const basePath = "https://some/root/path";
    const actual = transform(givenObject, basePath);

    expect(actual.children[0].objectType).toBe(OccupationAPISpecs.Enums.ObjectTypes.ISCOGroup);
  });
  ...
  test("should transform children with occupationType = ESCOOccupation", () => {
    ...
    expect(actual.children[0].objectType).toBe(OccupationAPISpecs.Enums.ObjectTypes.ESCOOccupation);
  });
  ...
  test("should transform children with occupationType = LocalOccupation", () => {
    ...
    expect(actual.children[0].objectType).toBe(OccupationAPISpecs.Enums.ObjectTypes.LocalOccupation);
  });
  ...
  test("should transform children with objectType = LocalGroup", () => {
    ...
    expect(actual.children[0].objectType).toBe(OccupationAPISpecs.Enums.ObjectTypes.LocalGroup);
  });
  ...
  test("should transform parent with objectType = LocalGroup", () => {
    ...
    expect(actual.parent!.objectType).toBe(OccupationAPISpecs.Enums.ObjectTypes.LocalGroup);
  });
  ...
  test("should transform parent with occupationType = LocalOccupation", () => {
    ...
    expect(actual.parent!.objectType).toBe(OccupationAPISpecs.Enums.ObjectTypes.LocalOccupation);
  });
});
...
describe("test the transformation of requiresSkills field", () => {
  ...
  test("should transform requiresSkills as empty array when requiresSkills is null", () => {
  ...
  test("should transform requiresSkills as empty array when requiresSkills is undefined", () => {
...
describe("test the transformation of originUUID field", () => {
  test("should set originUUID to the first UUID in UUIDHistory when UUIDHistory has items", () => {
    ...
    // THEN expect originUUID to be the first UUID in the history
    expect(actual.originUUID).toBe(firstUUID);
  });
