...
export async function lambda_invokeAsyncImport(request: Import.Types.ImportRequest) {
  try {
    ...
    return errorResponse(StatusCodes.INTERNAL_SERVER_ERROR, Import.Types.ImportResponseErrorCodes.FAILED_TO_TRIGGER_IMPORT, "Failed to trigger import", "");
  }
}
