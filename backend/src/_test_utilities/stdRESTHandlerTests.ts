...
export function testRequestJSONMalformed(handler: (event: APIGatewayProxyEvent, context: Context, callback: Callback)
  => Promise<APIGatewayProxyResult>) {
  test.each([
    ["is a malformed json", '{'],
    ["is a string", 'foo'],
...
export function testRequestJSONSchema(handler: (event: APIGatewayProxyEvent, context: Context, callback: Callback)
  => Promise<APIGatewayProxyResult>) {
...
export function testUnsupportedMediaType(handler: (event: APIGatewayProxyEvent, context: Context, callback: Callback)
  => Promise<APIGatewayProxyResult>) {
