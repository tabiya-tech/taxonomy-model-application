...
describe("test the handleRouteEvent function", () => {
  ...
  const occupationGroupParentPath = buildPathFromPattern(Routes.OCCUPATION_GROUP_PARENT_ROUTE, {
    modelId: modelId.toString(),
    id: getMockStringId(2),
  });
  ...
  const skillGroupHistoryPath = buildPathFromPattern(Routes.SKILL_GROUP_HISTORY_ROUTE, {
    modelId: modelId.toString(),
    id: getMockStringId(2),
  });
  ...
  describe.each([
    ...
    [skillGroupHistoryPath, SkillGroupHandler],
