...
ajvInstance.addSchema(
  OccupationAPISpecs.Occupation.Parent.PATCH.Schemas.Request.Payload,
  OccupationAPISpecs.Occupation.Parent.PATCH.Schemas.Request.Payload.$id
);
ajvInstance.addSchema(
...
ajvInstance.addSchema(
  OccupationAPISpecs.Occupation.Skills.PATCH.Schemas.Request.Payload,
  OccupationAPISpecs.Occupation.Skills.PATCH.Schemas.Request.Payload.$id
);
ajvInstance.addSchema(
...
ajvInstance.addSchema(
  ...
  SkillAPISpecs.Skill.PUT.Schemas.Request.Payload.$id
);
ajvInstance.addSchema(
  SkillAPISpecs.Skill.PUT.Schemas.Response.Payload,
  SkillAPISpecs.Skill.PUT.Schemas.Response.Payload.$id
);
ajvInstance.addSchema(
  SkillAPISpecs.Skill.PATCH.Schemas.Request.Payload,
  SkillAPISpecs.Skill.PATCH.Schemas.Request.Payload.$id
);
ajvInstance.addSchema(
  SkillAPISpecs.Skill.PATCH.Schemas.Response.Payload,
  SkillAPISpecs.Skill.PATCH.Schemas.Response.Payload.$id
);
ajvInstance.addSchema(
...
ajvInstance.addSchema(
  ...
  SkillAPISpecs.Skill.RelatedSkills.PATCH.Schemas.Request.Payload.$id
);
ajvInstance.addSchema(
  SkillAPISpecs.Skill.Parents.PATCH.Schemas.Request.Payload,
  SkillAPISpecs.Skill.Parents.PATCH.Schemas.Request.Payload.$id
);
ajvInstance.addSchema(
  SkillAPISpecs.Skill.Occupations.PATCH.Schemas.Request.Payload,
  SkillAPISpecs.Skill.Occupations.PATCH.Schemas.Request.Payload.$id
);
ajvInstance.addSchema(
