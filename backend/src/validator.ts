...
ajvInstance.addSchema(ModelInfoRequestSchemaPOST, ModelInfoRequestSchemaPOST.$id);
ajvInstance.addSchema(ModelInfoResponseSchemaPOST, ModelInfoResponseSchemaPOST.$id);
