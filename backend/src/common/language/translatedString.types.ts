 ...
 *
 * Every translated path of every entity is a Map path, built with TranslatedStringProperty(), so this is the one
 * shape a translated value is stored in; a value is written as a Map too and mongoose stores it as a BSON document.
 */
