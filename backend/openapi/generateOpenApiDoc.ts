...
delete OccupationGroup.POST.Schemas.Request.Payload.$id;
delete OccupationGroup.POST.Schemas.Response.Payload.$id;
delete OccupationGroup.GET.Schemas.Response.Payload.$id;
delete OccupationGroup.GET.Schemas.Request.Param.Payload.$id;
...
delete Occupation.GET.Schemas.Request.Param.Payload.$id;
delete Occupation.GET.Schemas.Request.Query.Payload.$id;
...
delete Skill.GET.Schemas.Response.Payload.$id;
delete Skill.Skill.GET.Schemas.Response.Payload.$id;
delete Skill.GET.Schemas.Request.Param.Payload.$id;
delete Skill.GET.Schemas.Request.Query.Payload.$id;
...
delete Skill.Skill.Parents.POST.Schemas.Response.Payload.$id;
...
delete Skill.Skill.Occupations.POST.Schemas.Response.Payload.$id;
      ...
      components: {
        ...
        schemas: {
          ...
          POSTOccupationGroup400ErrorSchema: APIError.Schemas.getPayload(
            ...
            "OccupationGroup",
            400,
            Object.values(OccupationGroup.POST.Enums.Response.Status400.ErrorCodes)
          ),
          GETOccupationGroup400ErrorSchema: APIError.Schemas.getPayload("GET", "OccupationGroup", 400, [
          ...
          GETOccupationGroup404ErrorSchema: APIError.Schemas.getPayload(
            ...
            "OccupationGroup",
            404,
            Object.values(OccupationGroup.GET.Enums.Response.Status404.ErrorCodes)
          ),
          ...
          POSTOccupation400ErrorSchema: APIError.Schemas.getPayload(
            ...
            "Occupation",
            400,
            Object.values(Occupation.POST.Errors.Status400.ErrorCodes)
          ),
          GETOccupation400ErrorSchema: APIError.Schemas.getPayload(
            "GET",
            "Occupation",
            400,
            Object.values(Occupation.GET.Errors.Status400.ErrorCodes)
          ),
          GETOccupation404ErrorSchema: APIError.Schemas.getPayload(
            "GET",
            "Occupation",
            404,
            Object.values(Occupation.GET.Errors.Status404.ErrorCodes)
          ),
          GETOccupations404ErrorSchema: APIError.Schemas.getPayload("GET", "Occupations", 404, [
            Occupation.GET.Errors.Status404.ErrorCodes.MODEL_NOT_FOUND,
          ]),
          GETOccupationParent404ErrorSchema: APIError.Schemas.getPayload("GET", "OccupationParent", 404, [
            ...(new Set([
              ...Object.values(Occupation.GET.Errors.Status404.ErrorCodes),
              ...Object.values(Occupation.Occupation.Parent.GET.Errors.Status404.ErrorCodes),
          ...
          GETSkillGroup400ErrorSchema: APIError.Schemas.getPayload("GET", "SkillGroup", 400, [
            ...(new Set([
              ...
              ...Object.values(SkillGroup.SkillGroup.GET.Enums.Response.Status400.ErrorCodes),
              ...Object.values(SkillGroup.SkillGroup.Parent.GET.Enums.Response.Status400.ErrorCodes),
              ...Object.values(SkillGroup.SkillGroup.Children.GET.Enums.Response.Status400.ErrorCodes),
            ]) as unknown as string[]),
          ]),
          GETSkillGroup404ErrorSchema: APIError.Schemas.getPayload("GET", "SkillGroup", 404, [
            ...(new Set([
              ...Object.values(SkillGroup.SkillGroup.GET.Enums.Response.Status404.ErrorCodes),
            ]) as unknown as string[]),
          ]),
          GETSkillGroups404ErrorSchema: APIError.Schemas.getPayload("GET", "SkillGroups", 404, [
            ...(new Set([
              ...Object.values(SkillGroup.GET.Enums.Response.Status404.ErrorCodes),
              ...Object.values(SkillGroup.SkillGroup.GET.Enums.Response.Status404.ErrorCodes),
              ...Object.values(SkillGroup.SkillGroup.Parent.GET.Enums.Response.Status404.ErrorCodes),
          ...
          POSTSkill400ErrorSchema: APIError.Schemas.getPayload(
            ...
            "Skill",
            400,
            Object.values(Skill.POST.Errors.Status400.ErrorCodes)
          ),
          GETSkill400ErrorSchema: APIError.Schemas.getPayload(
            "GET",
            "Skill",
            400,
            Object.values(Skill.GET.Errors.Status400.ErrorCodes)
          ),
          GETSkill404ErrorSchema: APIError.Schemas.getPayload(
            "GET",
            "Skill",
            404,
            Object.values(Skill.GET.Errors.Status404.ErrorCodes)
          ),
          GETSkills404ErrorSchema: APIError.Schemas.getPayload("GET", "Skills", 404, [
            Skill.GET.Errors.Status404.ErrorCodes.MODEL_NOT_FOUND,
          ]),
          ...
          GETSkillParents400ErrorSchema: APIError.Schemas.getPayload(
            ...
            "SkillParents",
            400,
            Object.values(Skill.GET.Errors.Status400.Parents.ErrorCodes)
          ),
          GETSkillParents404ErrorSchema: APIError.Schemas.getPayload(
            "GET",
            "SkillParents",
            404,
            Object.values(Skill.GET.Errors.Status404.Parents.ErrorCodes)
          ),
          GETSkillChildren400ErrorSchema: APIError.Schemas.getPayload(
            "GET",
            "SkillChildren",
            400,
            Object.values(Skill.GET.Errors.Status400.Children.ErrorCodes)
          ),
          GETSkillChildren404ErrorSchema: APIError.Schemas.getPayload(
            "GET",
            "SkillChildren",
            404,
            Object.values(Skill.GET.Errors.Status404.Children.ErrorCodes)
          ),
          GETSkillOccupations400ErrorSchema: APIError.Schemas.getPayload(
            "GET",
            "SkillOccupations",
            400,
            Object.values(Skill.GET.Errors.Status400.Occupations.ErrorCodes)
          ),
          GETSkillOccupations404ErrorSchema: APIError.Schemas.getPayload(
            "GET",
            "SkillOccupations",
            404,
            Object.values(Skill.GET.Errors.Status404.Occupations.ErrorCodes)
          ),
          GETSkillRelated400ErrorSchema: APIError.Schemas.getPayload(
            "GET",
            "SkillRelated",
            400,
            Object.values(Skill.GET.Errors.Status400.RelatedSkills.ErrorCodes)
          ),
          ...
          OccupationRequestQueryParamSchemaGET: Occupation.GET.Schemas.Request.Query.Payload,
          ...
          OccupationSkillsRequestSchemaPATCH: Occupation.Occupation.Skills.PATCH.Schemas.Request.Payload,
          OccupationSkillItemResponseSchemaPATCH: Occupation.Occupation.Skills.PATCH.Schemas.Response.Payload,
          ...
          SkillGroupRequestQueryParamSchemaGET: SkillGroup.GET.Schemas.Request.Query.Payload,
