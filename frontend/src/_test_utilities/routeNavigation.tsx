...
export function testNavigateToPath(givenComponentWithLink: React.ReactElement, givenElementName: string, givenElementToClickTestId: string, expectedPath: string): void {
  return test(`clicking the '${givenElementName}' should navigate to '${expectedPath}'`, async () => {
    ...
    const givenRouter = <MemoryRouter initialEntries={["/foo-initial-path"]}>
      <>
