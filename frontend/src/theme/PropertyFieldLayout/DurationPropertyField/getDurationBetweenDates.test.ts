...
describe("getDurationBetweenDates", () => {
  test("returns the expected duration in days", () => {
    // GIVEN two dates
  ...
  test("returns the expected duration in hours", () => {
    // GIVEN two dates
  ...
  test("returns the expected duration in minutes", () => {
    // GIVEN two dates
    const givenFirstDate = new Date("2021-10-10T10:00:00");
  ...
  test("returns the expected duration in seconds", () => {
    // GIVEN two dates
    const givenFirstDate = new Date("2021-10-10T10:00:00");
  ...
  test("returns the expected duration in days, hours, minutes and seconds", () => {
    // GIVEN two dates
    const givenFirstDate = new Date("2021-10-10T10:00:00");
  ...
  test("return the expected duration in 'day'", () => {
    // GIVEN two dates
    const givenFirstDate = new Date("2021-10-10");
  ...
  test("return the expected duration in 'hour'", () => {
    // GIVEN two dates
    const givenFirstDate = new Date("2021-10-10T10:00:00");
  ...
  test("return the expected duration in 'minute'", () => {
    // GIVEN two dates
    const givenFirstDate = new Date("2021-10-10T10:00:00");
  ...
  test("return the expected duration in 'second'", () => {
    // GIVEN two dates
    const givenFirstDate = new Date("2021-10-10T10:00:00");
