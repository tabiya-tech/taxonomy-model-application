...
const AppHeader = () =>{
    return (
        ...
        >
            <NavLink to="/" data-testid={DATA_TEST_ID.APP_HEADER_LOGO_LINK}>
                <img src='/logo.svg' alt="Tabiya" height={30} data-testid={DATA_TEST_ID.APP_HEADER_LOGO}/>
            </NavLink>
            <Box display="flex" alignItems="center" gap={{ xs: '14px', md: '28px' }} data-testid={DATA_TEST_ID.APP_HEADER_ICONS_CONTAINER}>
