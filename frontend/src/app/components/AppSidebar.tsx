...
const appSidebarItems = [
    {
        icon: <FolderOutlinedIcon sx={{ width: '24px', height: '24px' }} data-testid={DATA_TEST_ID.APP_SIDEBAR_ICON_DIRECTORY} className="item-icon" />,
        label: ITEMS_LABEL_TEXT[DATA_TEST_ID.APP_SIDEBAR_ICON_DIRECTORY],
        pathName: '/',
        iconLinkTestID: DATA_TEST_ID.APP_SIDEBAR_DIRECTORY_LINK
    },
    {
        icon: <VerticalSplitOutlinedIcon sx={{ width: '24px', height: '24px' }} data-testid={DATA_TEST_ID.APP_SIDEBAR_ICON_EXPLORE} className="item-icon" />,
        label: ITEMS_LABEL_TEXT[DATA_TEST_ID.APP_SIDEBAR_ICON_EXPLORE],
        pathName: '/explore',
        iconLinkTestID: DATA_TEST_ID.APP_SIDEBAR_EXPLORE_LINK
    },
    {
        icon: <EditOutlinedIcon sx={{ width: '24px', height: '24px' }} data-testid={DATA_TEST_ID.APP_SIDEBAR_ICON_EDIT} className="item-icon" />,
        label: ITEMS_LABEL_TEXT[DATA_TEST_ID.APP_SIDEBAR_ICON_EDIT],
        pathName: 'edit',
        iconLinkTestID: DATA_TEST_ID.APP_SIDEBAR_EDIT_LINK
    },
    {
        icon: <PermIdentityIcon sx={{ width: '24px', height: '24px' }} data-testid={DATA_TEST_ID.APP_SIDEBAR_ICON_USER} className="item-icon" />,
        label: ITEMS_LABEL_TEXT[DATA_TEST_ID.APP_SIDEBAR_ICON_USER],
        pathName: '/users',
        iconLinkTestID: DATA_TEST_ID.APP_SIDEBAR_USER_LINK
    },
    {
        icon: <SettingsIcon sx={{ width: '24px', height: '24px' }} data-testid={DATA_TEST_ID.APP_SIDEBAR_ICON_SETTINGS} className="item-icon" />,
...
const AppSidebar = () => {
    return (
        <Box display="flex" flexDirection="column" alignItems="center" paddingX="16px" marginTop="44px" gap="12px" data-testid={DATA_TEST_ID.APP_SIDEBAR_CONTAINER}>
            {appSidebarItems.map((item) => (
                <CustomNavLink
                    key={item.pathName}
                    to={item.pathName}
                    data-testid={item.iconLinkTestID}
                >
                    {item.icon}
