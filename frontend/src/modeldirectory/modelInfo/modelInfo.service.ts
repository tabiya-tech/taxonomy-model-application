...
import {LocaleSchema, ModelInfo, ModelInfoResponseSchemaGET} from "api-specifications/modelInfo"
...
const responseValidator: ValidateFunction = ajv.getSchema(ModelInfoResponseSchemaGET.$id as string) as ValidateFunction;
