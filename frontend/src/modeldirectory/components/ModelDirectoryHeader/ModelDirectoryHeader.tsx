...
import { AuthContext, TabiyaUserRole, UserRoleContextValue } from "src/app/providers/AuthProvider";
...
const ModelDirectoryHeader: React.FC<ModelDirectoryHeaderProps> = ({
  ...
  const { hasRole } = React.useContext(AuthContext) as UserRoleContextValue;
