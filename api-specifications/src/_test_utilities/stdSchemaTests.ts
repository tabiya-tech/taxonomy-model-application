...
export const testSchemaWithValidObject = (description: string, schema: SchemaObject, validObject: object, dependencies:SchemaObject[] = []) => {
...
export const testSchemaWithInvalidObject = (description: string, schema: SchemaObject, validObject: object, dependencies: SchemaObject[] = []) => {
...
export const assertValidationErrors = (givenObject: unknown, givenSchema: SchemaObject, failure: Array<unknown>, dependencies: SchemaObject[] = []) => {
