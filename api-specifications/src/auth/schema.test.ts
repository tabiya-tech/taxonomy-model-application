...
import {
  ...
  testSchemaSuccessWithAdditionalProperties,
  ...
  describe("Validate Auth.Schemas.GET.Response.Payload fields", () => {
    ...
    describe("Test validation of 'roles'", () => {
      test.each([
        ...
        // in this case, since the roles field can be undefined, we filter out the "undefined" case
      ...
      ])(`(%s) Validate roles when it is %s`, (caseType, _description, givenValue, failureMessages) => {
