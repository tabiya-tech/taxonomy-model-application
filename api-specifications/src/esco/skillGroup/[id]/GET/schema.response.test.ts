...
import SkillGroupGETDetailAPISpecs from "./index";
...
describe("Test SkillGroupGETDetailAPISpecs schema validity", () => {
  // WHEN the SkillGroupGETDetailAPISpecs.Response.Schema.Payload schema
  // THEN expect the givenSchema to be valid
  testValidSchema(
    "SkillGroupGETDetailAPISpecs.Schemas.Response.Payload",
    SkillGroupGETDetailAPISpecs.Schemas.Response.Payload
  );
});

describe("Test objects against the SkillGroupGETDetailAPISpecs.Schemas.Response.Payload schema", () => {
  ...
  describe("Validate SkillGroupGETDetailAPISpecs.Schemas.Response.Payload fields", () => {
    describe("Test validate of 'id' ", () => {
      testObjectIdField("id", SkillGroupGETDetailAPISpecs.Schemas.Response.Payload);
    });
    describe("Test validate of 'UUID'", () => {
      testUUIDField<SkillGroupGETDetailAPISpecs.Types.Response.Payload>(
        "UUID",
        SkillGroupGETDetailAPISpecs.Schemas.Response.Payload
      );
    });
    ...
    describe("Test validate of 'UUIDHistory'", () => {
      testUUIDArray<SkillGroupGETDetailAPISpecs.Types.Response.Payload>(
        "UUIDHistory",
        SkillGroupGETDetailAPISpecs.Schemas.Response.Payload,
        [],
        true
    ...
    describe("Test validation of 'path'", () => {
      testURIField<SkillGroupGETDetailAPISpecs.Types.Response.Payload>(
        "path",
    ...
    describe("Test validation of 'originUri'", () => {
      testNonEmptyURIStringField<SkillGroupGETDetailAPISpecs.Types.Response.Payload>(
        "originUri",
    ...
    describe("Test validate of 'description'", () => {
      testStringField<SkillGroupGETDetailAPISpecs.Types.Response.Payload>(
        "description",
    ...
    describe("Test validate of 'preferredLabel'", () => {
      testNonEmptyStringField<SkillGroupGETDetailAPISpecs.Types.Response.Payload>(
        "preferredLabel",
    ...
    describe("Test validation of 'modelId'", () => {
      testObjectIdField("modelId", SkillGroupGETDetailAPISpecs.Schemas.Response.Payload);
    });

    describe("Test validate of 'createdAt'", () => {
      testTimestampField<SkillGroupGETDetailAPISpecs.Types.Response.Payload>(
        "createdAt",
        SkillGroupGETDetailAPISpecs.Schemas.Response.Payload
      );
    });
