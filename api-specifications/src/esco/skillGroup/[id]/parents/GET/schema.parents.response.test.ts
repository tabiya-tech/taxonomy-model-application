...
import SkillGroupGETParentAPISpecs from "./index";
...
describe("Test SkillGroupParents Schema Validity", () => {
  testValidSchema(
    "SkillGroupGETParentAPISpecs.Schemas.Response.Parents.Payload",
    SkillGroupGETParentAPISpecs.Schemas.Response.Parents.Payload
  );
});

describe("Test the object against the SkillGroupGETParentAPISpecs.Schemas.Response.Parents.Payload schema", () => {
  // GIVEN a valid parents response payload objet
  const givenChild = {
    id: getMockId(2),
    UUID: randomUUID(),
    preferredLabel: getTestString(SkillGroupConstants.PREFERRED_LABEL_MAX_LENGTH),
    objectType: SkillGroupGETParentAPISpecs.Enums.Relations.Children.ObjectTypes.SkillGroup,
  ...
  describe("Validate SkillGroupGETParentAPISpecs.Schemas.Response.Parents.Payload fields", () => {
    ...
    const { properties, ...rest } = SkillGroupGETParentAPISpecs.Schemas.Response.Parents.Payload;
    ...
    describe("Test Validate of 'UUID'", () => {
      testUUIDField<SkillGroupGETParentAPISpecs.Types.Response.Parents.Payload>("UUID", givenSchema);
    });

    describe("Test validate of 'originUUID'", () => {
      testUUIDField<SkillGroupGETParentAPISpecs.Types.Response.Parents.Payload>("originUUID", givenSchema);
    });

    describe("Test validate of 'UUIDHistory'", () => {
      testUUIDArray<SkillGroupGETParentAPISpecs.Types.Response.Parents.Payload>(
        "UUIDHistory",
        givenSchema,
        [],
        true,
    ...
    describe("Test validate of 'path'", () => {
      testURIField<SkillGroupGETParentAPISpecs.Types.Response.Parents.Payload>(
        "path",
    ...
    describe("Test validate of 'originUri'", () => {
      testNonEmptyURIStringField<SkillGroupGETParentAPISpecs.Types.Response.Parents.Payload>(
        "originUri",
    ...
    describe("Test validate of 'description'", () => {
      testStringField<SkillGroupGETParentAPISpecs.Types.Response.Parents.Payload>(
        "description",
    ...
    describe("Test validate of 'preferredLabel'", () => {
      testNonEmptyStringField<SkillGroupGETParentAPISpecs.Types.Response.Parents.Payload>(
        "preferredLabel",
    ...
    describe("Test validate of 'createdAt'", () => {
      testTimestampField<SkillGroupGETParentAPISpecs.Types.Response.Parents.Payload>("createdAt", givenSchema);
    });
    describe("Test validate of 'updatedAt'", () => {
      testTimestampField<SkillGroupGETParentAPISpecs.Types.Response.Parents.Payload>("updatedAt", givenSchema);
    });
