...
describe("Test SkillGroup Parents Request Query Schema Validity", () => {
  testValidSchema(
    "SkillGroupGETParentAPISpecs.Schemas.Request.Query.Payload",
    SkillGroupGETParentAPISpecs.Schemas.Request.Query.Payload
  );
});

describe("Test objects against the SkillGroupGETParentAPISpecs.Schemas.Request.Query.Payload schema", () => {
  ...
  describe("Validate SkillGroupGETParentAPISpecs.Schemas.Request.Query.Payload fields", () => {
    const givenSchema = SkillGroupGETParentAPISpecs.Schemas.Request.Query.Payload;
