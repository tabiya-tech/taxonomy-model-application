...
describe("Test SkillGroupGETParentAPISpecs schema validity", () => {
  // WHEN the SkillGroupGETParentAPISpecs.GET.Response.Parent.Schema.Payload schema
  // THEN expect the givenSchema to be valid
  testValidSchema(
    "SkillGroupGETParentAPISpecs.Schemas.Response.Payload",
    SkillGroupGETParentAPISpecs.Schemas.Response.Payload
  );
});
describe("Test objects against the SkillGroupGETParentAPISpecs.Response.Payload schema", () => {
  ...
  const validSkillGroupParentResponsePayload = {
    id: getMockId(1),
    UUID: randomUUID(),
  ...
  testSchemaWithValidObject(
    "SkillGroupGETParentAPISpecs.Schemas.Response.Payload",
    SkillGroupGETParentAPISpecs.Schemas.Response.Payload,
    validSkillGroupParentResponsePayload
  );
  ...
  testSchemaWithAdditionalProperties(
    "SkillGroupGETParentAPISpecs.Schemas.Response.Payload",
    SkillGroupGETParentAPISpecs.Schemas.Response.Payload,
    { ...validSkillGroupParentResponsePayload, additionalProperty: "foo" }
  );
  describe("Validate SkillGroupGETParentAPISpecs.Schemas.Response.Payload fields", () => {
    describe("Test validate of 'id' ", () => {
      testObjectIdField("id", SkillGroupGETParentAPISpecs.Schemas.Response.Payload);
    });
    describe("Test validate of 'UUID'", () => {
      testUUIDField<SkillGroupGETParentAPISpecs.Types.Response.Payload>(
        "UUID",
        SkillGroupGETParentAPISpecs.Schemas.Response.Payload
      );
    });
    ...
    describe("Test validate of 'UUIDHistory'", () => {
      testUUIDArray<SkillGroupGETParentAPISpecs.Types.Response.Payload>(
        "UUIDHistory",
        SkillGroupGETParentAPISpecs.Schemas.Response.Payload,
        [],
        true
    ...
    describe("Test validation of 'path'", () => {
      testURIField<SkillGroupGETParentAPISpecs.Types.Response.Payload>(
        "path",
    ...
    describe("Test validation of 'originUri'", () => {
      testNonEmptyURIStringField<SkillGroupGETParentAPISpecs.Types.Response.Payload>(
        "originUri",
    ...
    describe("Test validate of 'description'", () => {
      testStringField<SkillGroupGETParentAPISpecs.Types.Response.Payload>(
        "description",
    ...
    describe("Test validate of 'preferredLabel'", () => {
      testNonEmptyStringField<SkillGroupGETParentAPISpecs.Types.Response.Payload>(
        "preferredLabel",
    ...
    describe("Test validation of 'modelId'", () => {
      testObjectIdField("modelId", SkillGroupGETParentAPISpecs.Schemas.Response.Payload);
    });

    describe("Test validate of 'createdAt'", () => {
      testTimestampField<SkillGroupGETParentAPISpecs.Types.Response.Payload>(
        "createdAt",
        SkillGroupGETParentAPISpecs.Schemas.Response.Payload
      );
    });
