...
describe("Test SkillGroup Schema Validity", () => {
  testValidSchema(
    "SkillGroupGETAPISpecs.Schemas.Response.Schema.Payload",
    SkillGroupGETAPISpecs.Schemas.Response.Payload
  );
});

describe("Test the object against the SkillGroupGETAPISpecs.Schemas.Response.Payload schema", () => {
  ...
  describe("Validate SkillGroupGETAPISpecs.Schemas.Response.Payload fields", () => {
    ...
    const { properties, ...rest } = SkillGroupGETAPISpecs.Schemas.Response.Payload;
    ...
    describe("Test Validate of 'UUID'", () => {
      testUUIDField<SkillGroupGETAPISpecs.Types.Response.Payload>("UUID", givenSchema);
    });

    describe("Test validate of 'originUUID'", () => {
      testUUIDField<SkillGroupGETAPISpecs.Types.Response.Payload>("originUUID", givenSchema);
    });

    describe("Test validate of 'UUIDHistory'", () => {
      testUUIDArray<SkillGroupGETAPISpecs.Types.Response.Payload>("UUIDHistory", givenSchema, [], true, true);
    });

    describe("Test validate of 'path'", () => {
      testURIField<SkillGroupGETAPISpecs.Types.Response.Payload>(
        "path",
    ...
    describe("Test validate of 'originUri'", () => {
      testNonEmptyURIStringField<SkillGroupGETAPISpecs.Types.Response.Payload>(
        "originUri",
    ...
    describe("Test validate of 'description'", () => {
      testStringField<SkillGroupGETAPISpecs.Types.Response.Payload>(
        "description",
    ...
    describe("Test validate of 'preferredLabel'", () => {
      testNonEmptyStringField<SkillGroupGETAPISpecs.Types.Response.Payload>(
        "preferredLabel",
    ...
    describe("Test validate of 'createdAt'", () => {
      testTimestampField<SkillGroupGETAPISpecs.Types.Response.Payload>("createdAt", givenSchema);
    });
    describe("Test validate of 'updatedAt'", () => {
      testTimestampField<SkillGroupGETAPISpecs.Types.Response.Payload>("updatedAt", givenSchema);
    });
