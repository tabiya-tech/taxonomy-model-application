...
describe("Test SkillGroupParents Schema Validity", () => {
  testValidSchema(
    "SkillGroupAPISpecs.Schemas.GET.Response.Parents.Payload",
    SkillGroupAPISpecs.Schemas.GET.Response.Parents.Payload
  );
});

describe("Test the object against the SkillGroupAPISpecs.Schemas.GET.Response.Parents.Payload schema", () => {
  ...
  describe("Validate SkillGroupAPISpecs.Schemas.GET.Response.Parents.Payload fields", () => {
    ...
    const { properties, ...rest } = SkillGroupAPISpecs.Schemas.GET.Response.Parents.Payload;
    ...
    describe("Test Validate of 'UUID'", () => {
      testUUIDField<SkillGroupAPISpecs.Types.GET.Response.Parents.Payload>("UUID", givenSchema);
    });

    describe("Test validate of 'originUUID'", () => {
      testUUIDField<SkillGroupAPISpecs.Types.GET.Response.Parents.Payload>("originUUID", givenSchema);
    });

    describe("Test validate of 'UUIDHistory'", () => {
      testUUIDArray<SkillGroupAPISpecs.Types.GET.Response.Parents.Payload>("UUIDHistory", givenSchema, [], true, true);
    });

    describe("Test validate of 'path'", () => {
      testURIField<SkillGroupAPISpecs.Types.GET.Response.Parents.Payload>(
        "path",
    ...
    describe("Test validate of 'originUri'", () => {
      testNonEmptyURIStringField<SkillGroupAPISpecs.Types.GET.Response.Parents.Payload>(
        "originUri",
    ...
    describe("Test validate of 'description'", () => {
      testStringField<SkillGroupAPISpecs.Types.GET.Response.Parents.Payload>(
        "description",
    ...
    describe("Test validate of 'preferredLabel'", () => {
      testNonEmptyStringField<SkillGroupAPISpecs.Types.GET.Response.Parents.Payload>(
        "preferredLabel",
    ...
    describe("Test validate of 'createdAt'", () => {
      testTimestampField<SkillGroupAPISpecs.Types.GET.Response.Parents.Payload>("createdAt", givenSchema);
    });
    describe("Test validate of 'updatedAt'", () => {
      testTimestampField<SkillGroupAPISpecs.Types.GET.Response.Parents.Payload>("updatedAt", givenSchema);
    });
