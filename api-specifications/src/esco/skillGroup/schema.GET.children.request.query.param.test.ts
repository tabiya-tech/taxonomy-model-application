...
describe("Test objects against the SkillGroupAPISpecs.Schemas.GET.Children.Request.Query.Payload schema", () => {
  ...
  describe("Validate SkillGroupAPISpecs.Schemas.GET.Children.Request.Query.Payload fields", () => {
    const givenSchema = SkillGroupAPISpecs.Schemas.GET.Children.Request.Query.Payload;
