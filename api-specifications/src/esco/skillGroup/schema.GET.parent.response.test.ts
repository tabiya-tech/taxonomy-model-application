...
describe("Test SkillGroupAPISpecs schema validity", () => {
  // WHEN the SkillGroupAPISpecs.GET.Response.Parent.Schema.Payload schema
  // THEN expect the givenSchema to be valid
  testValidSchema(
    "SkillGroupAPISpecs.Schemas.GET.Response.Parent.Payload",
    SkillGroupAPISpecs.Schemas.GET.Response.Parent.Payload
  );
});
describe("Test objects against the SkillGroupAPISpecs.GET.Response.Parent.Payload schema", () => {
  ...
  describe("Validate SkillGroupAPISpecs.Schemas.GET.Response.Parent.Payload fields", () => {
    describe("Test validate of 'id' ", () => {
      testObjectIdField("id", SkillGroupAPISpecs.Schemas.GET.Response.Parent.Payload);
    });
    describe("Test validate of 'UUID'", () => {
      testUUIDField<SkillGroupAPISpecs.Types.GET.Response.Parent.Payload>(
        "UUID",
        SkillGroupAPISpecs.Schemas.GET.Response.Parent.Payload
      );
    });
    ...
    describe("Test validate of 'UUIDHistory'", () => {
      testUUIDArray<SkillGroupAPISpecs.Types.GET.Response.Parent.Payload>(
        "UUIDHistory",
        SkillGroupAPISpecs.Schemas.GET.Response.Parent.Payload,
        [],
        true
    ...
    describe("Test validation of 'path'", () => {
      testURIField<SkillGroupAPISpecs.Types.GET.Response.Parent.Payload>(
        "path",
    ...
    describe("Test validation of 'originUri'", () => {
      testNonEmptyURIStringField<SkillGroupAPISpecs.Types.GET.Response.Parent.Payload>(
        "originUri",
    ...
    describe("Test validate of 'description'", () => {
      testStringField<SkillGroupAPISpecs.Types.GET.Response.Parent.Payload>(
        "description",
    ...
    describe("Test validate of 'preferredLabel'", () => {
      testNonEmptyStringField<SkillGroupAPISpecs.Types.GET.Response.Parent.Payload>(
        "preferredLabel",
    ...
    describe("Test validation of 'modelId'", () => {
      testObjectIdField("modelId", SkillGroupAPISpecs.Schemas.GET.Response.Parent.Payload);
    });

    describe("Test validate of 'createdAt'", () => {
      testTimestampField<SkillGroupAPISpecs.Types.GET.Response.Parent.Payload>(
        "createdAt",
        SkillGroupAPISpecs.Schemas.GET.Response.Parent.Payload
      );
    });
