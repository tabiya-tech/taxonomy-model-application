...
describe("Test SkillGroupPOSTAPISpecs schema validity", () => {
  // WHEN the SkillGroupPOSTAPISpecs.POST.Response.Schema.Payload schema
  // THEN expect the givenSchema to be valid
  testValidSchema(
    "SkillGroupPOSTAPISpecs.Schemas.POST.Response.Payload",
    SkillGroupPOSTAPISpecs.Schemas.Response.Payload
  );
});
describe("Test objects against the SkillGroupPOSTAPISpecs.Schemas.Response.Payload schema", () => {
  // GIVEN a valid parent response payload schema
  const givenParent = {
    id: getMockId(1),
    UUID: randomUUID(),
    code: getTestSkillGroupCode(),
    preferredLabel: getTestString(SkillGroupPOSTAPISpecs.Constants.PREFERRED_LABEL_MAX_LENGTH),
  ...
  const validSkillGroupResponsePayload = {
    ...
    code: getTestSkillGroupCode(),
    description: getTestString(SkillGroupPOSTAPISpecs.Constants.DESCRIPTION_MAX_LENGTH),
    preferredLabel: getTestString(SkillGroupPOSTAPISpecs.Constants.PREFERRED_LABEL_MAX_LENGTH),
    parents: [givenParent],
    children: [givenChild],
    altLabels: [getTestString(SkillGroupPOSTAPISpecs.Constants.ALT_LABEL_MAX_LENGTH)],
    modelId: getMockId(1),
    scopeNote: getTestString(SkillGroupPOSTAPISpecs.Constants.MAX_SCOPE_NOTE_LENGTH),
  ...
  describe("Validate SkillGroupPOSTAPISpecs.Schemas.Response.Payload fields", () => {
    describe("Test validate of 'id' ", () => {
      testObjectIdField("id", SkillGroupPOSTAPISpecs.Schemas.Response.Payload);
    });
    describe("Test validate of 'UUID'", () => {
      testUUIDField<SkillGroupPOSTAPISpecs.Types.Response.Payload>(
        "UUID",
        SkillGroupPOSTAPISpecs.Schemas.Response.Payload
      );
    });
    ...
    describe("Test validate of 'UUIDHistory'", () => {
      testUUIDArray<SkillGroupPOSTAPISpecs.Types.Response.Payload>(
        "UUIDHistory",
        SkillGroupPOSTAPISpecs.Schemas.Response.Payload,
        [],
        true
    ...
    describe("Test validation of 'path'", () => {
      testURIField<SkillGroupPOSTAPISpecs.Types.Response.Payload>(
        "path",
        SkillGroupPOSTAPISpecs.Constants.MAX_PATH_URI_LENGTH,
        SkillGroupPOSTAPISpecs.Schemas.Response.Payload
      );
    });
    ...
    describe("Test validation of 'tabiyaPath'", () => {
      testURIField<SkillGroupPOSTAPISpecs.Types.Response.Payload>(
        "tabiyaPath",
        SkillGroupPOSTAPISpecs.Constants.MAX_TABIYA_PATH_LENGTH,
        SkillGroupPOSTAPISpecs.Schemas.Response.Payload
      );
    });

    describe("Test validation of 'originUri'", () => {
      testNonEmptyURIStringField<SkillGroupPOSTAPISpecs.Types.Response.Payload>(
        "originUri",
    ...
    describe("Test validate of 'description'", () => {
      testStringField<SkillGroupPOSTAPISpecs.Types.Response.Payload>(
        "description",
    ...
    describe("Test validate of 'preferredLabel'", () => {
      testNonEmptyStringField<SkillGroupPOSTAPISpecs.Types.Response.Payload>(
        "preferredLabel",
    ...
    describe("Test validation of 'modelId'", () => {
      testObjectIdField("modelId", SkillGroupPOSTAPISpecs.Schemas.Response.Payload);
    });

    describe("Test validate of 'createdAt'", () => {
      testTimestampField<SkillGroupPOSTAPISpecs.Types.Response.Payload>(
        "createdAt",
        SkillGroupPOSTAPISpecs.Schemas.Response.Payload
      );
    });
      ...
      test.each([
        ...
        [
          ...
          "a valid parents object",
          {
            id: getMockId(1),
            UUID: randomUUID(),
            code: getTestSkillGroupCode(SkillGroupPOSTAPISpecs.Constants.CODE_MAX_LENGTH),
            preferredLabel: getTestString(SkillGroupPOSTAPISpecs.Constants.PREFERRED_LABEL_MAX_LENGTH),
            objectType: SkillGroupEnums.Relations.Parents.ObjectTypes.SkillGroup,
          },
      ...
      describe("Test validation of 'parents/code'", () => {
        test.each([
          ...
          [
            CaseType.Failure,
            "a random string",
            getTestString(SkillGroupPOSTAPISpecs.Constants.CODE_MAX_LENGTH),
            constructSchemaError(
              "/parents/0/code",
              "pattern",
              `must match pattern "${SkillGroupRegexes.Str.SKILL_GROUP_CODE}"`
          ...
          [
            ...
            getTestString(SkillGroupPOSTAPISpecs.Constants.CODE_MAX_LENGTH - 2, "9"),
            constructSchemaError(
              "/parents/0/code",
              "pattern",
              `must match pattern "${SkillGroupRegexes.Str.SKILL_GROUP_CODE}"`
