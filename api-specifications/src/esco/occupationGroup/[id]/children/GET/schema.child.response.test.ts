...
describe("Test OccupationGroup child Validity", () => {
  // WHEN the OccupationGroupGETChildrenAPISpecs.Schemas.Response.Child.Payload schema
  // THEN expect the givenSchema to be valid
  testValidSchema(
    "OccupationGroupGETChildrenAPISpecs.Schemas.Response.Child.Payload",
    OccupationGroupGETChildrenAPISpecs.Schemas.Response.Child.Payload
  );
});

describe("Test objects against the OccupationGroupGETChildrenAPISpecs.Schemas.Response.Child.Payload schema", () => {
  ...
  const givenValidOccupationGroupGETChildResponsePayload = {
    ...
    objectType: OccupationGroupEnums.ObjectTypes.LocalGroup,
    modelId: getMockId(1),
  ...
  testSchemaWithValidObject(
    "OccupationGroupGETChildrenAPISpecs.Schemas.Response.Child.Payload with valid object",
    OccupationGroupGETChildrenAPISpecs.Schemas.Response.Child.Payload,
  ...
  testSchemaWithAdditionalProperties(
    "OccupationGroupGETChildrenAPISpecs.Schemas.Response.Child.Payload with additional properties",
    OccupationGroupGETChildrenAPISpecs.Schemas.Response.Child.Payload,
    { ...givenValidOccupationGroupGETChildResponsePayload, extraProperty: "foo" }
  );

  describe("validate OccupationGroupGETChildrenAPISpecs.Schemas.Response.Child.Payload fields", () => {
    describe("Test validate of 'id'", () => {
      testObjectIdField("id", OccupationGroupGETChildrenAPISpecs.Schemas.Response.Child.Payload);
    });
    describe("Test validate of 'parentId'", () => {
      testObjectIdField("parentId", OccupationGroupGETChildrenAPISpecs.Schemas.Response.Child.Payload);
    });
    describe("Test validate of 'UUID'", () => {
      testUUIDField<OccupationGroupGETChildrenAPISpecs.Types.Response.Child.Payload>(
        "UUID",
        OccupationGroupGETChildrenAPISpecs.Schemas.Response.Child.Payload
      );
    });
    ...
    describe("Test validate of 'UUIDHistory'", () => {
      testUUIDArray<OccupationGroupGETChildrenAPISpecs.Types.Response.Child.Payload>(
        "UUIDHistory",
        OccupationGroupGETChildrenAPISpecs.Schemas.Response.Child.Payload,
        [],
        true
    ...
    describe("Test validation of 'path'", () => {
      testURIField<OccupationGroupGETChildrenAPISpecs.Types.Response.Child.Payload>(
        "path",
    ...
    describe("Test validate of 'originUri'", () => {
      testNonEmptyURIStringField<OccupationGroupGETChildrenAPISpecs.Types.Response.Child.Payload>(
        "originUri",
    ...
    describe("Test validate of 'description'", () => {
      testStringField<OccupationGroupGETChildrenAPISpecs.Types.Response.Child.Payload>(
        "description",
    ...
    describe("Test validate of 'preferredLabel'", () => {
      testNonEmptyStringField<OccupationGroupGETChildrenAPISpecs.Types.Response.Child.Payload>(
        "preferredLabel",
    ...
    describe("Test validation of 'modelId'", () => {
      testObjectIdField("modelId", OccupationGroupGETChildrenAPISpecs.Schemas.Response.Child.Payload);
    });
    describe("Test validate of 'createdAt'", () => {
      testTimestampField<OccupationGroupGETChildrenAPISpecs.Types.Response.Child.Payload>(
        "createdAt",
        OccupationGroupGETChildrenAPISpecs.Schemas.Response.Child.Payload
      );
    });
