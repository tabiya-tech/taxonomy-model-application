describe("Test the occupationGroup GET children operation module", () => {
  test("The occupationGroup GET children operation module can be required via the index", async () => {
