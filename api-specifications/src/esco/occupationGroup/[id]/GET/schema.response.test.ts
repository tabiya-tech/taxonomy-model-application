...
import OccupationGroupGETDetailAPISpecs from "./index";
...
describe("Test OccupationGroupGETDetailAPISpecs schema validity", () => {
  // WHEN the OccupationGroupGETDetailAPISpecs.Response.Schema.Payload schema
  // THEN expect the givenSchema to be valid
  testValidSchema(
    "OccupationGroupGETDetailAPISpecs.Schemas.Response.Payload",
    OccupationGroupGETDetailAPISpecs.Schemas.Response.Payload
  );
});

describe("Test objects against the OccupationGroupGETDetailAPISpecs.Schemas.Response.Payload schema", () => {
  ...
  const givenValidOccupationGroupGETDetailResponse = {
    id: getMockId(1),
    UUID: randomUUID(),
  ...
  testSchemaWithValidObject(
    "OccupationGroupGETDetailAPISpecs.Schemas.Response.Payload",
    OccupationGroupGETDetailAPISpecs.Schemas.Response.Payload,
    givenValidOccupationGroupGETDetailResponse
  );
  ...
  testSchemaWithAdditionalProperties(
    "OccupationGroupGETDetailAPISpecs.Schemas.Response.Payload",
    OccupationGroupGETDetailAPISpecs.Schemas.Response.Payload,
    { ...givenValidOccupationGroupGETDetailResponse, extraProperty: "foo" }
  );

  describe("Validate OccupationGroupGETDetailAPISpecs.Schemas.Response.Payload fields", () => {
    describe("Test validate of 'id'", () => {
      testObjectIdField("id", OccupationGroupGETDetailAPISpecs.Schemas.Response.Payload);
    });

    describe("Test validate of 'UUID'", () => {
      testUUIDField<OccupationGroupGETDetailAPISpecs.Types.Payload>(
        "UUID",
        OccupationGroupGETDetailAPISpecs.Schemas.Response.Payload
      );
    });
    ...
    describe("Test validate of 'UUIDHistory'", () => {
      testUUIDArray<OccupationGroupGETDetailAPISpecs.Types.Payload>(
        "UUIDHistory",
        OccupationGroupGETDetailAPISpecs.Schemas.Response.Payload,
        [],
        true
    ...
    describe("Test validation of 'path'", () => {
      testURIField<OccupationGroupGETDetailAPISpecs.Types.Payload>(
        "path",
    ...
    describe("Test validation of 'originUri'", () => {
      testNonEmptyURIStringField<OccupationGroupGETDetailAPISpecs.Types.Payload>(
        "originUri",
    ...
    describe("Test validate of 'description'", () => {
      testStringField<OccupationGroupGETDetailAPISpecs.Types.Payload>(
        "description",
    ...
    describe("Test validate of 'preferredLabel'", () => {
      testNonEmptyStringField<OccupationGroupGETDetailAPISpecs.Types.Payload>(
        "preferredLabel",
    ...
    describe("Test validation of 'modelId'", () => {
      testObjectIdField("modelId", OccupationGroupGETDetailAPISpecs.Schemas.Response.Payload);
    });

    describe("Test validate of 'createdAt'", () => {
      testTimestampField<OccupationGroupGETDetailAPISpecs.Types.Payload>(
        "createdAt",
        OccupationGroupGETDetailAPISpecs.Schemas.Response.Payload
      );
    });
