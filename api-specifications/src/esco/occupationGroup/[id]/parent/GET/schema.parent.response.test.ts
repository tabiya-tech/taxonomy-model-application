...
describe("Test OccupationGroupGETParentAPISpecs schema validity", () => {
  ...
  testValidSchema(
    "OccupationGroupGETParentAPISpecs.Schemas.Response.Payload",
    OccupationGroupGETParentAPISpecs.Schemas.Response.Payload
  );
});

describe("Test objects against the  OccupationGroupGETParentAPISpecs.Schemas.Response.Payload schema", () => {
  ...
  describe("Validate OccupationGroupGETParentAPISpecs.Schemas.Response.Payload fields", () => {
    describe("Test validate of 'id'", () => {
      testObjectIdField("id", OccupationGroupGETParentAPISpecs.Schemas.Response.Payload);
    });
    describe("Test validate of 'UUID'", () => {
      testUUIDField<OccupationGroupGETParentAPISpecs.Types.Response.Payload>(
        "UUID",
        OccupationGroupGETParentAPISpecs.Schemas.Response.Payload
      );
    });
    ...
    describe("Test validate of 'UUIDHistory'", () => {
      testUUIDArray<OccupationGroupGETParentAPISpecs.Types.Response.Payload>(
        "UUIDHistory",
        OccupationGroupGETParentAPISpecs.Schemas.Response.Payload,
        [],
        true
    ...
    describe("Test validation of 'path'", () => {
      testURIField<OccupationGroupGETParentAPISpecs.Types.Response.Payload>(
        "path",
    ...
    describe("Test validation of 'originUri'", () => {
      testNonEmptyURIStringField<OccupationGroupGETParentAPISpecs.Types.Response.Payload>(
        "originUri",
    ...
    describe("Test validate of 'description'", () => {
      testStringField<OccupationGroupGETParentAPISpecs.Types.Response.Payload>(
        "description",
    ...
    describe("Test validate of 'preferredLabel'", () => {
      testNonEmptyStringField<OccupationGroupGETParentAPISpecs.Types.Response.Payload>(
        "preferredLabel",
    ...
    describe("Test validation of 'modelId'", () => {
      testObjectIdField("modelId", OccupationGroupGETParentAPISpecs.Schemas.Response.Payload);
    });

    describe("Test validate of 'createdAt'", () => {
      testTimestampField<OccupationGroupGETParentAPISpecs.Types.Response.Payload>(
        "createdAt",
        OccupationGroupGETParentAPISpecs.Schemas.Response.Payload
      );
    });
