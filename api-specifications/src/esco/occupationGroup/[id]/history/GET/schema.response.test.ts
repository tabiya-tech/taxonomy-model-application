...
describe("Test objects against the OccupationGroup History Response Schema", () => {
  ...
  testSchemaWithValidObject(
    "OccupationGroupAPISpecs.OccupationGroup.History.GET.Schemas.Response.Payload (single item)",
    OccupationGroupAPISpecs.OccupationGroup.History.GET.Schemas.Response.Payload,
  ...
  testSchemaWithValidObject(
    "OccupationGroupAPISpecs.OccupationGroup.History.GET.Schemas.Response.Payload (multiple items)",
    OccupationGroupAPISpecs.OccupationGroup.History.GET.Schemas.Response.Payload,
