...
describe("Test OccupationGroup Schema Validity", () => {
  testValidSchema(
    "OccupationGroupGETAPISpecs.Schemas.Response.Schema.Payload",
    OccupationGroupGETAPISpecs.Schemas.Response.Payload
  );
});

describe("Test objects against the OccupationGroupGETAPISpecs.Schemas.Response.Payload schema", () => {
  ...
  describe("Validate OccupationGroupGETAPISpecs.Schemas.Response.Payload fields", () => {
    ...
    const { properties, ...rest } = OccupationGroupGETAPISpecs.Schemas.Response.Payload;
    ...
    describe("Test Validate of 'UUID'", () => {
      testUUIDField<OccupationGroupGETAPISpecs.Types.Response.Payload>("UUID", givenSchema);
    });

    describe("Test validate of 'originUUID'", () => {
      testUUIDField<OccupationGroupGETAPISpecs.Types.Response.Payload>("originUUID", givenSchema);
    });

    describe("Test validate of 'UUIDHistory'", () => {
      testUUIDArray<OccupationGroupGETAPISpecs.Types.Response.Payload>("UUIDHistory", givenSchema, [], true, true);
    });

    describe("Test validate of 'path'", () => {
      testURIField<OccupationGroupGETAPISpecs.Types.Response.Payload>(
        "path",
    ...
    describe("Test validate of 'originUri'", () => {
      testNonEmptyURIStringField<OccupationGroupGETAPISpecs.Types.Response.Payload>(
        "originUri",
    ...
    describe("Test validate of 'description'", () => {
      testStringField<OccupationGroupGETAPISpecs.Types.Response.Payload>(
        "description",
    ...
    describe("Test validate of 'preferredLabel'", () => {
      testNonEmptyStringField<OccupationGroupGETAPISpecs.Types.Response.Payload>(
        "preferredLabel",
    ...
    describe("Test validate of 'createdAt'", () => {
      testTimestampField<OccupationGroupGETAPISpecs.Types.Response.Payload>("createdAt", givenSchema);
    });
    describe("Test validate of 'updatedAt'", () => {
      testTimestampField<OccupationGroupGETAPISpecs.Types.Response.Payload>("updatedAt", givenSchema);
    });
