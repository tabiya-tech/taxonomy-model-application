...
describe("Test OccupationGroupPOSTAPISpecs schema validity", () => {
  // WHEN the OccupationGroupPOSTAPISpecs.Response.Schema.Payload schema
  // THEN expect the givenSchema to be valid
  testValidSchema(
    "OccupationGroupPOSTAPISpecs.Schemas.POST.Response.Payload",
    OccupationGroupPOSTAPISpecs.Schemas.Response.Payload
  );
});

describe("Test objects against the OccupationGroupPOSTAPISpecs.Schemas.Response.Payload schema", () => {
  ...
  describe("Validate OccupationGroupPOSTAPISpecs.Schemas.Response.Payload fields", () => {
    describe("Test validate of 'id'", () => {
      testObjectIdField("id", OccupationGroupPOSTAPISpecs.Schemas.Response.Payload);
    });

    describe("Test validate of 'UUID'", () => {
      testUUIDField<OccupationGroupPOSTAPISpecs.Types.Response.Payload>(
        "UUID",
        OccupationGroupPOSTAPISpecs.Schemas.Response.Payload
      );
    });
    ...
    describe("Test validate of 'UUIDHistory'", () => {
      testUUIDArray<OccupationGroupPOSTAPISpecs.Types.Response.Payload>(
        "UUIDHistory",
        OccupationGroupPOSTAPISpecs.Schemas.Response.Payload,
        [],
        true
    ...
    describe("Test validation of 'path'", () => {
      testURIField<OccupationGroupPOSTAPISpecs.Types.Response.Payload>(
        "path",
    ...
    describe("Test validation of 'originUri'", () => {
      testNonEmptyURIStringField<OccupationGroupPOSTAPISpecs.Types.Response.Payload>(
        "originUri",
    ...
    describe("Test validate of 'description'", () => {
      testStringField<OccupationGroupPOSTAPISpecs.Types.Response.Payload>(
        "description",
    ...
    describe("Test validate of 'preferredLabel'", () => {
      testNonEmptyStringField<OccupationGroupPOSTAPISpecs.Types.Response.Payload>(
        "preferredLabel",
    ...
    describe("Test validation of 'modelId'", () => {
      testObjectIdField("modelId", OccupationGroupPOSTAPISpecs.Schemas.Response.Payload);
    });

    describe("Test validate of 'createdAt'", () => {
      testTimestampField<OccupationGroupPOSTAPISpecs.Types.Response.Payload>(
        "createdAt",
        OccupationGroupPOSTAPISpecs.Schemas.Response.Payload
      );
    });
