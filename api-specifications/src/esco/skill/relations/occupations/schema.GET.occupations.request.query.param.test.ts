...
describe("Test objects against the SkillAPISpecs.Schemas.GET.Occupations.Request.Query.Payload schema", () => {
  ...
  describe("Validate SkillAPISpecs.Schemas.GET.Occupations.Request.Query.Payload fields", () => {
    const givenSchema = SkillAPISpecs.Schemas.GET.Occupations.Request.Query.Payload;
