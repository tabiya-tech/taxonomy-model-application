...
const SchemaGETOccupationsRequestQuery: SchemaObject = {
  $id: "/components/schemas/SkillOccupationsRequestQuerySchemaGET",
  type: "object",
...
export default SchemaGETOccupationsRequestQuery;
