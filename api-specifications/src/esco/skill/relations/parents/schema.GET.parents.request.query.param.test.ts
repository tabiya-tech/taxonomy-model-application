...
describe("Test objects against the SkillAPISpecs.Schemas.GET.Parents.Request.Query.Payload schema", () => {
  ...
  describe("Validate SkillAPISpecs.Schemas.GET.Parents.Request.Query.Payload fields", () => {
    const givenSchema = SkillAPISpecs.Schemas.GET.Parents.Request.Query.Payload;
