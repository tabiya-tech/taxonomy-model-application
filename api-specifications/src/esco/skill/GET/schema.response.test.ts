...
describe("Test Skill Schema Validity", () => {
  ...
  testValidSchema("SkillAPISpecs.GET.Schemas.Response.Payload", SkillAPISpecs.GET.Schemas.Response.Payload);
});

describe("Test objects against the SkillAPISpecs.GET.Schemas.Response.Payload schema", () => {
  ...
  describe("Validate SkillAPISpecs.GET.Schemas.Response.Payload fields", () => {
    const givenSchema = SkillAPISpecs.GET.Schemas.Response.Payload;
    ...
    describe("Test validation of skill items", () => {
      const itemSchema = SkillAPISpecs.GET.Schemas.Response.Payload.properties.data.items;
      ...
      describe("Test validation of 'UUID'", () => {
        testUUIDField<SkillAPISpecs.Types.POSTSkill.Request.Payload>("UUID", itemSchema);
      });

      describe("Test validation of 'originUUID'", () => {
        testUUIDField<SkillAPISpecs.Types.POSTSkill.Request.Payload>("originUUID", itemSchema);
      });

      describe("Test validation of 'UUIDHistory'", () => {
        testUUIDArray<SkillAPISpecs.Types.GETSkills.Response.Payload>("UUIDHistory", itemSchema, [], true, true);
      });
      ...
      describe("Test validation of 'preferredLabel'", () => {
        testNonEmptyStringField<SkillAPISpecs.Types.POSTSkill.Request.Payload>(
          "preferredLabel",
      ...
      describe("Test validation of 'description'", () => {
        testStringField<SkillAPISpecs.Types.POSTSkill.Request.Payload>(
          "description",
      ...
      describe("Test validation of 'parents'", () => {
        test.each([
          ...
          assertCaseForProperty("parents", givenObject, itemSchema, caseType, failureMessages);
        });
      });
      ...
      describe("Test validation of parents fields", () => {
        ...
        describe("Test validation of 'parents/objectType'", () => {
          test.each([
            ...
            assertCaseForProperty("/parents/0/objectType", givenObject, itemSchema, caseType, failureMessage);
          });
        });
        describe("Test validation of 'parents/code'", () => {
          test.each([
            ...
            assertCaseForProperty("/parents/0/code", givenObject, itemSchema, caseType, failureMessage);
          });
        });
      });
      ...
      describe("Test validation of 'children'", () => {
        test.each([
          ...
          [
            ...
            constructSchemaError("/children/0", "required", "must have required property 'id'"),
          ],
          [
            CaseType.Failure,
            "children with missing UUID",
            [
              {
                id: getMockId(1),
                preferredLabel: getTestString(10),
            ...
            constructSchemaError("/children/0", "required", "must have required property 'UUID'"),
          ],
          [
            CaseType.Failure,
            "children with missing preferredLabel",
            [
              {
                id: getMockId(1),
                UUID: randomUUID(),
            ...
            constructSchemaError("/children/0", "required", "must have required property 'preferredLabel'"),
          ],
          [
            CaseType.Failure,
            "children with missing objectType",
            [
              {
                id: getMockId(1),
                UUID: randomUUID(),
      ...
      describe("Test validation of children fields", () => {
        ...
        describe("Test validation of 'children/isLocalized'", () => {
          test.each([
            ...
            assertCaseForProperty("/children/0/isLocalized", givenObject, itemSchema, caseType, failureMessage);
          });
        });
      });
        ...
        test.each([
          ...
          [
            ...
            constructSchemaError(
              ...
              "required",
              "must have required property 'preferredLabel'"
            ),
          ],
          [
            CaseType.Failure,
      ...
      describe("Test validation of requiredBySkills fields", () => {
          ...
          test.each(testCases)(
            ...
            (caseType, _description, givenValue, failureMessages) => {
              const givenObject = {
                ...
                requiredBySkills: [
                  {
                    ...givenRequiredBySkills[0],
                    id: givenValue,
                  },
                ],
              };
              assertCaseForProperty("/requiredBySkills/0/id", givenObject, itemSchema, caseType, failureMessages);
            }
          );
        });
        describe("Test validation of 'requiredBySkills/UUID'", () => {
          ...
          test.each(testCases)(
            ...
            (caseType, _description, givenValue, failureMessages) => {
              ...
              assertCaseForProperty("/requiredBySkills/0/UUID", givenObject, itemSchema, caseType, failureMessages);
            }
          );
        });
        ...
        describe("Test validation of 'requiredBySkills/isLocalized'", () => {
          test.each([
            ...
            assertCaseForProperty("/requiredBySkills/0/isLocalized", givenObject, itemSchema, caseType, failureMessage);
          });
        });
        describe("Test validation of 'requiredBySkills/objectType'", () => {
          test.each([
            ...
            assertCaseForProperty("/requiredBySkills/0/objectType", givenObject, itemSchema, caseType, failureMessage);
          });
        });
            ...
            (caseType, _description, givenValue, failureMessages) => {
              const givenObject = {
                ...
                requiredByOccupations: [
                  {
                    ...givenRequiredByOccupations[0],
                    id: givenValue,
                  },
                ],
              };
              assertCaseForProperty("/requiredByOccupations/0/id", givenObject, itemSchema, caseType, failureMessages);
            }
          );
        });
      ...
      describe("Test validation of 'createdAt'", () => {
        testTimestampField<SkillAPISpecs.Types.POSTSkill.Request.Payload>("createdAt", itemSchema);
      });
      describe("Test validation of 'updatedAt'", () => {
        testTimestampField<SkillAPISpecs.Types.POSTSkill.Request.Payload>("updatedAt", itemSchema);
      });
    });
  });
});
