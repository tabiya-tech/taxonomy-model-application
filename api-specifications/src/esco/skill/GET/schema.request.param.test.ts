...
describe("Test Skill GET Request Param Schema Validity", () => {
  ...
  testValidSchema("SkillAPISpecs.GET.Schemas.Request.Param.Payload", SkillAPISpecs.GET.Schemas.Request.Param.Payload);
});
...
describe("Test objects against the SkillAPISpecs.Schemas.GET.Request.Param schema", () => {
  ...
  describe("Validate SkillAPISpecs.GET.Schemas.Request.Param.Payload fields", () => {
    describe("Test validation of 'modelId'", () => {
      testObjectIdField("modelId", SkillAPISpecs.GET.Schemas.Request.Param.Payload);
    });
  });
});
