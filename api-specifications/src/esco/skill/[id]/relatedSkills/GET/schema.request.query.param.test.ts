...
describe("Test objects against the SkillAPISpecs.Skill.RelatedSkills.GET.Schemas.Request.Query.Payload schema", () => {
  ...
  describe("Validate SkillAPISpecs.Skill.RelatedSkills.GET.Schemas.Request.Query.Payload fields", () => {
    const givenSchema = SkillAPISpecs.Skill.RelatedSkills.GET.Schemas.Request.Query.Payload;
