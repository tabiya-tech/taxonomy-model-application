...
describe("Test Skill Related Response Schema Validity", () => {
  testValidSchema(
    "SkillAPISpecs.Skill.RelatedSkills.GET.Schemas.Response.Payload",
    SkillAPISpecs.Skill.RelatedSkills.GET.Schemas.Response.Payload
  );
});

describe("Test objects against the SkillAPISpecs.Skill.RelatedSkills.GET.Schemas.Response.Payload schema", () => {
  ...
  describe("Validate SkillAPISpecs.Skill.RelatedSkills.GET.Schemas.Response.Payload fields", () => {
    const givenSchema = SkillAPISpecs.Skill.RelatedSkills.GET.Schemas.Response.Payload;
    ...
    describe("Test validation of related skill item fields", () => {
      const itemSchema = {
        ...SkillAPISpecs.Skill.RelatedSkills.GET.Schemas.Response.Payload.properties.data.items,
