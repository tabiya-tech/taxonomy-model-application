...
describe("Test Skill Occupations Request Query Schema Validity", () => {
  testValidSchema(
...
describe("Test objects against the SkillAPISpecs.Skill.Occupations.GET.Schemas.Request.Query.Payload schema", () => {
  ...
  describe("Validate SkillAPISpecs.Skill.Occupations.GET.Schemas.Request.Query.Payload fields", () => {
    const givenSchema = SkillAPISpecs.Skill.Occupations.GET.Schemas.Request.Query.Payload;
