...
describe("Test Skill Occupations Response Schema Validity", () => {
  testValidSchema(
    "SkillAPISpecs.Skill.Occupations.GET.Schemas.Response.Payload",
    SkillAPISpecs.Skill.Occupations.GET.Schemas.Response.Payload
  );
});

describe("Test objects against the SkillAPISpecs.Skill.Occupations.GET.Schemas.Response.Payload schema", () => {
  ...
  describe("Validate SkillAPISpecs.Skill.Occupations.GET.Schemas.Response.Payload fields", () => {
    const givenSchema = SkillAPISpecs.Skill.Occupations.GET.Schemas.Response.Payload;
    ...
    describe("Test validation of occupation item fields", () => {
      const itemSchema = {
        ...SkillAPISpecs.Skill.Occupations.GET.Schemas.Response.Payload.properties.data.items,
