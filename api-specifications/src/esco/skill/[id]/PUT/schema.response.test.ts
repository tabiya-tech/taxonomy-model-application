...
describe("SkillAPISpecs.Skill.PUT.Schemas.Response.Payload schema", () => {
  testValidSchema("SkillAPISpecs.Skill.PUT.Schemas.Response.Payload", SkillAPISpecs.Skill.PUT.Schemas.Response.Payload);
});

describe("Test objects against the SkillAPISpecs.Skill.PUT.Schemas.Response.Payload schema", () => {
  const givenParent = {
    id: getMockId(1),
    UUID: randomUUID(),
  ...
  const givenValidSkillPUTResponse = {
    id: getMockId(10),
    UUID: randomUUID(),
