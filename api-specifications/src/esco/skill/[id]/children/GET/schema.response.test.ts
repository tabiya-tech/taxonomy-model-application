...
describe("Test Skill Children Response Schema Validity", () => {
  testValidSchema(
    "SkillAPISpecs.Skill.Children.GET.Schemas.Response.Payload",
    SkillAPISpecs.Skill.Children.GET.Schemas.Response.Payload
  );
});

describe("Test objects against the SkillAPISpecs.Skill.Children.GET.Schemas.Response.Payload schema", () => {
  ...
  describe("Validate SkillAPISpecs.Skill.Children.GET.Schemas.Response.Payload fields", () => {
    const givenSchema = SkillAPISpecs.Skill.Children.GET.Schemas.Response.Payload;
    ...
    describe("Test validation of child item fields", () => {
      const itemSchema = {
        ...SkillAPISpecs.Skill.Children.GET.Schemas.Response.Payload.properties.data.items,
      ...
      describe("Test validation of 'UUID'", () => {
        testUUIDField<SkillAPISpecs.Types.Detail.Children.GET.Response.Payload>("UUID", itemSchema);
      });

      describe("Test validation of 'preferredLabel'", () => {
        testNonEmptyStringField<SkillAPISpecs.Types.Detail.Children.GET.Response.Payload>(
          "preferredLabel",
