...
describe("Test objects against the SkillAPISpecs.Skill.Children.GET.Schemas.Request.Query.Payload schema", () => {
  ...
  describe("Validate SkillAPISpecs.Skill.Children.GET.Schemas.Request.Query.Payload fields", () => {
    const givenSchema = SkillAPISpecs.Skill.Children.GET.Schemas.Request.Query.Payload;
