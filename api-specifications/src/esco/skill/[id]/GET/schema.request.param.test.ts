...
describe("Test objects against the SkillAPISpecs.Schemas.GET.Request.ById.Param schema", () => {
  ...
  describe("Validate SkillAPISpecs.Skill.GET.Schemas.Request.Param.Payload fields", () => {
    describe("Test validation of 'modelId'", () => {
      testObjectIdField("modelId", SkillAPISpecs.Skill.GET.Schemas.Request.Param.Payload);
    });

    describe("Test validation of 'id'", () => {
      testObjectIdField("id", SkillAPISpecs.Skill.GET.Schemas.Request.Param.Payload);
    });
  });
});
