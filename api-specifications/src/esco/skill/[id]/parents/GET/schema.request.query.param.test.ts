...
import { getValidSkillRelationRequestQuery } from "./schemaTestData";

describe("Test Skill Parents Request Query Schema Validity", () => {
  testValidSchema(
...
describe("Test objects against the SkillAPISpecs.Skill.Parents.GET.Schemas.Request.Query.Payload schema", () => {
  const givenValidQuery = getValidSkillRelationRequestQuery();
  ...
  describe("Validate SkillAPISpecs.Skill.Parents.GET.Schemas.Request.Query.Payload fields", () => {
    const givenSchema = SkillAPISpecs.Skill.Parents.GET.Schemas.Request.Query.Payload;
