...
describe("Test Skill Parents Response Schema Validity", () => {
  testValidSchema(
    "SkillAPISpecs.Skill.Parents.GET.Schemas.Response.Payload",
    SkillAPISpecs.Skill.Parents.GET.Schemas.Response.Payload
  );
});

describe("Test objects against the SkillAPISpecs.Skill.Parents.GET.Schemas.Response.Payload schema", () => {
  testSchemaWithValidObject(
    "SkillAPISpecs.Skill.Parents.GET.Schemas.Response.Payload (empty data)",
    SkillAPISpecs.Skill.Parents.GET.Schemas.Response.Payload,
    getValidSkillParentsPaginatedResponse()
  );

  testSchemaWithValidObject(
    "SkillAPISpecs.Skill.Parents.GET.Schemas.Response.Payload (Skill)",
    SkillAPISpecs.Skill.Parents.GET.Schemas.Response.Payload,
    getValidSkillParentsPaginatedResponse({ data: [getValidSkillParentItem()] })
  );

  testSchemaWithValidObject(
    "SkillAPISpecs.Skill.Parents.GET.Schemas.Response.Payload (SkillGroup)",
    SkillAPISpecs.Skill.Parents.GET.Schemas.Response.Payload,
