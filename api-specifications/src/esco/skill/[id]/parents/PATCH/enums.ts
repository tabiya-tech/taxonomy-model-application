namespace PATCHSkillParentsErrors {
  ...
  export namespace Status500 {
    export enum ErrorCodes {
      DB_FAILED_TO_UPDATE_SKILL_PARENT_RELATION = "DB_FAILED_TO_UPDATE_SKILL_PARENT_RELATION",
    }
  }
}

export default PATCHSkillParentsErrors;
