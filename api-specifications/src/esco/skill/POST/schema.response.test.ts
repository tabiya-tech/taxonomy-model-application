...
import SkillGroupSpecs from "../../skillGroup";
import { getTestSkillGroupCode } from "../../_test_utilities/testUtils";

describe("Test Skill POST Response Schema Validity", () => {
  // WHEN the SkillAPISpecs.POST.Schemas.Response.Payload schema
  // THEN expect the givenSchema to be valid
  testValidSchema("SkillAPISpecs.POST.Schemas.Response.Payload", SkillAPISpecs.POST.Schemas.Response.Payload);
});

describe("Test objects against the SkillAPISpecs.POST.Schemas.Response.Payload schema", () => {
  ...
  testSchemaWithValidObject(
    "SkillAPISpecs.POST.Schemas.Response.Payload",
    SkillAPISpecs.POST.Schemas.Response.Payload,
  ...
  describe("Validate SkillAPISpecs.POST.Schemas.Response.Payload fields", () => {
    const givenSchema = SkillAPISpecs.POST.Schemas.Response.Payload;
    ...
    describe("Test validation of 'UUID'", () => {
      testUUIDField<SkillAPISpecs.Types.POSTSkill.Response.Payload>("UUID", givenSchema);
    });

    describe("Test validation of 'originUUID'", () => {
      testUUIDField<SkillAPISpecs.Types.POSTSkill.Response.Payload>("originUUID", givenSchema);
    });

    describe("Test validation of 'UUIDHistory'", () => {
      testUUIDArray<SkillAPISpecs.Types.POSTSkill.Response.Payload>("UUIDHistory", givenSchema, [], true, true);
    });
    ...
    describe("Test validation of 'preferredLabel'", () => {
      testNonEmptyStringField<SkillAPISpecs.Types.POSTSkill.Response.Payload>(
        "preferredLabel",
    ...
    describe("Test validation of 'description'", () => {
      testStringField<SkillAPISpecs.Types.POSTSkill.Response.Payload>(
        "description",
      ...
      test.each([
        ...
        [
          ...
          "parent object missing id",
          {
            ...
            preferredLabel: getTestString(SkillAPISpecs.Constants.PREFERRED_LABEL_MAX_LENGTH),
            objectType: SkillEnums.ObjectTypes.SkillGroup,
            code: getTestSkillGroupCode(SkillGroupSpecs.Constants.CODE_MAX_LENGTH),
          },
        ...
        test.each([
          ...
          [
            ...
            constructSchemaError(
              "/parents/0/code",
              "pattern",
              `must match pattern "${SkillGroupSpecs.Patterns.Str.SKILL_GROUP_CODE}"`
            ),
          ],
          [
            CaseType.Failure,
            "too long",
            getTestString(SkillGroupSpecs.Constants.CODE_MAX_LENGTH + 1),
            constructSchemaError(
              "/parents/0/code",
              "maxLength",
              `must NOT have more than ${SkillGroupSpecs.Constants.CODE_MAX_LENGTH} characters`
            ),
          ],
          [
            CaseType.Failure,
    ...
    describe("Test validation of requiredByOccupations fields", () => {
      ...
      describe("Test validation of 'requiredByOccupations/relationType'", () => {
        test.each([
          // ESCO occupation → relationType required and must be string from enum
          [
            CaseType.Success,
          ...
          [
            ...
            "OPTIONAL relationType for ESCOOccupation",
            {
              ...givenValidSkillPOSTResponse.requiredByOccupations[0],
              objectType: SkillEnums.OccupationObjectTypes.ESCOOccupation,
              relationType: SkillEnums.OccupationToSkillRelationType.OPTIONAL,
            },
            undefined,
          ],
          [
            ...
            "NONE relationType for ESCOOccupation",
            {
              ...givenValidSkillPOSTResponse.requiredByOccupations[0],
              objectType: SkillEnums.OccupationObjectTypes.ESCOOccupation,
              relationType: SkillEnums.OccupationToSkillRelationType.NONE,
            },
            undefined,
          ],
          [
          ...
          [
            ...
            "invalid relationType for ESCOOccupation",
            {
              ...givenValidSkillPOSTResponse.requiredByOccupations[0],
              objectType: SkillEnums.OccupationObjectTypes.ESCOOccupation,
              relationType: "invalidRelationType",
            },
            constructSchemaError(
          ...
          // Local occupation → relationType optional, can be undefined/null/enum
          [
            CaseType.Success,
          ...
          [
            CaseType.Success,
            "empty string relationType for LocalOccupation",
            {
              ...givenValidSkillPOSTResponse.requiredByOccupations[0],
              objectType: SkillEnums.OccupationObjectTypes.LocalOccupation,
              relationType: "",
      ...
      describe("Test validation of 'requiredByOccupations/signallingValue'", () => {
        test.each([
          // ESCO occupation: signalling fields optional
          [
            CaseType.Success,
            "undefined signallingValue for ESCOOccupation",
            {
              ...givenValidSkillPOSTResponse.requiredByOccupations[0],
              objectType: SkillEnums.OccupationObjectTypes.ESCOOccupation,
              signallingValue: undefined,
            },
            undefined,
          ],
          [
            CaseType.Success,
            "null signallingValue for ESCOOccupation",
            {
              ...givenValidSkillPOSTResponse.requiredByOccupations[0],
              objectType: SkillEnums.OccupationObjectTypes.ESCOOccupation,
          ...
          // Local occupation: signallingValue required and must be number
          [
            CaseType.Failure,
            "undefined signallingValue for LocalOccupation",
            {
              ...givenValidSkillPOSTResponse.requiredByOccupations[0],
              objectType: SkillEnums.OccupationObjectTypes.LocalOccupation,
              signallingValue: undefined,
          ...
          [
            CaseType.Failure,
            "null signallingValue for LocalOccupation",
            {
              ...givenValidSkillPOSTResponse.requiredByOccupations[0],
              objectType: SkillEnums.OccupationObjectTypes.LocalOccupation,
              signallingValue: null,
            },
            constructSchemaError("/requiredByOccupations/0/signallingValue", "type", "must be number"),
          ],
          [
            CaseType.Failure,
            "string",
          ...
          [
            ...
            "below min",
            {
              ...givenValidSkillPOSTResponse.requiredByOccupations[0],
              objectType: SkillEnums.OccupationObjectTypes.LocalOccupation,
              signallingValue: SkillConstants.SIGNALLING_VALUE_MIN - 1,
            },
            constructSchemaError(
          ...
          [
            ...
            "above max",
            {
              ...givenValidSkillPOSTResponse.requiredByOccupations[0],
              objectType: SkillEnums.OccupationObjectTypes.LocalOccupation,
              signallingValue: SkillConstants.SIGNALLING_VALUE_MAX + 1,
            },
            constructSchemaError(
              "/requiredByOccupations/0/signallingValue",
              "maximum",
          ...
          [
            CaseType.Success,
            "min signallingValue for LocalOccupation",
            {
              ...givenValidSkillPOSTResponse.requiredByOccupations[0],
              objectType: SkillEnums.OccupationObjectTypes.LocalOccupation,
              signallingValue: SkillConstants.SIGNALLING_VALUE_MIN,
            },
            undefined,
          ],
          [
            CaseType.Success,
            "max signallingValue for LocalOccupation",
            {
              ...givenValidSkillPOSTResponse.requiredByOccupations[0],
              objectType: SkillEnums.OccupationObjectTypes.LocalOccupation,
              signallingValue: SkillConstants.SIGNALLING_VALUE_MAX,
            },
            undefined,
          ],
      ...
      describe("Test validation of 'requiredByOccupations/signallingValueLabel'", () => {
        test.each([
          // ESCO occupation: signallingValueLabel optional
          [
            CaseType.Success,
            "undefined signallingValueLabel for ESCOOccupation",
            {
              ...givenValidSkillPOSTResponse.requiredByOccupations[0],
              objectType: SkillEnums.OccupationObjectTypes.ESCOOccupation,
          ...
          [
            CaseType.Success,
            "null signallingValueLabel for ESCOOccupation",
            {
              ...givenValidSkillPOSTResponse.requiredByOccupations[0],
              objectType: SkillEnums.OccupationObjectTypes.ESCOOccupation,
          ...
          // Local occupation: signallingValueLabel required and must be string
          [
            CaseType.Failure,
            "undefined signallingValueLabel for LocalOccupation",
            {
              ...givenValidSkillPOSTResponse.requiredByOccupations[0],
              objectType: SkillEnums.OccupationObjectTypes.LocalOccupation,
              signallingValueLabel: undefined,
          ...
          [
            CaseType.Failure,
            "null signallingValueLabel for LocalOccupation",
            {
              ...givenValidSkillPOSTResponse.requiredByOccupations[0],
              objectType: SkillEnums.OccupationObjectTypes.LocalOccupation,
              signallingValueLabel: null,
            },
            constructSchemaError("/requiredByOccupations/0/signallingValueLabel", "type", "must be string"),
          ],
          [
            CaseType.Failure,
            "number",
          ...
          [
            CaseType.Success,
            "empty string signallingValueLabel for LocalOccupation",
            {
              ...givenValidSkillPOSTResponse.requiredByOccupations[0],
              objectType: SkillEnums.OccupationObjectTypes.LocalOccupation,
          ...
          [
            CaseType.Success,
            "a valid label for LocalOccupation",
            {
              ...givenValidSkillPOSTResponse.requiredByOccupations[0],
              objectType: SkillEnums.OccupationObjectTypes.LocalOccupation,
    ...
    describe("Test validation of 'createdAt'", () => {
      testTimestampField<SkillAPISpecs.Types.POSTSkill.Response.Payload>("createdAt", givenSchema);
    });

    describe("Test validation of 'updatedAt'", () => {
      testTimestampField<SkillAPISpecs.Types.POSTSkill.Response.Payload>("updatedAt", givenSchema);
    });
  });
});
