...
describe("Test Skill POST Request Schema Validity", () => {
  // WHEN the SkillAPISpecs.POST.Schemas.Request.Payload schema
  // THEN expect the givenSchema to be valid
  testValidSchema("SkillAPISpecs.POST.Schemas.Request.Payload", SkillAPISpecs.POST.Schemas.Request.Payload);
});

describe("Test objects against the SkillAPISpecs.POST.Schemas.Request.Payload schema", () => {
  ...
  describe("Validate SkillAPISpecs.POST.Schemas.Request.Payload fields", () => {
    const givenSchema = SkillAPISpecs.POST.Schemas.Request.Payload;

    describe("Test validation of 'UUIDHistory'", () => {
      testUUIDArray<SkillAPISpecs.Types.POSTSkill.Request.Payload>("UUIDHistory", givenSchema, [], true, true);
    });
