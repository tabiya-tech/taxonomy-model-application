...
namespace SkillEnums {
  ...
  export enum OccupationObjectTypes {
    ...
    export namespace Response {
      export namespace Status400 {
        export enum ErrorCodes {
          INVALID_LIMIT_PARAMETER = "INVALID_LIMIT_PARAMETER_FOR_SKILLS",
          INVALID_NEXT_CURSOR_PARAMETER = "INVALID_NEXT_CURSOR_PARAMETER_FOR_SKILLS",
    ...
    export namespace Response {
      export namespace Status400 {
        export enum ErrorCodes {
          ...
          UNABLE_TO_ALTER_RELEASED_MODEL = "UNABLE_TO_ALTER_RELEASED_MODEL_FOR_SKILLS",
        }
      }
      export namespace Status404 {
        export enum ErrorCodes {
          MODEL_NOT_FOUND = "MODEL_NOT_FOUND_FOR_SKILL_CREATE",
        }
      }
      export namespace Status500 {
        export enum ErrorCodes {
