  ...
  export namespace GET {
    export namespace Response {
      export enum ErrorCodes {
        ...
        INVALID_LIMIT = "INVALID_LIMIT_SKILLS",
        INVALID_NEXT_CURSOR = "INVALID_NEXT_CURSOR_SKILLS",
      }
    }
  }
  ...
  export namespace POST {
    export namespace Response {
      export enum ErrorCodes {
        ...
        DB_FAILED_TO_RETRIEVE_A_SINGLE_SKILL = "DB_FAILED_TO_RETRIEVE_A_SINGLE_SKILL_GROUP",
        DB_FAILED_TO_CREATE_SKILL_ON_ALREADY_RELEASED_MODEL = "DB_FAILED_TO_CREATE_SKILL_GROUP_ON_ALREADY_RELEASED_MODEL",
