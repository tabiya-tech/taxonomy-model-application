...
describe("Test Occupation Children Response Schema Validity", () => {
  // WHEN the OccupationAPISpecs.Detail.children.GET.Schemas.Response.Payload schema
...
describe("Test objects against the OccupationAPISpecs.Detail.children.GET.Schemas.Response.Payload schema", () => {
