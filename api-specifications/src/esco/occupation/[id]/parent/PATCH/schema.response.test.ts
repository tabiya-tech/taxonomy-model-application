...
describe("OccupationAPISpecs.Occupation.Parent.PATCH.Schemas.Response.Payload schema", () => {
  testValidSchema(
    "OccupationAPISpecs.Occupation.Parent.PATCH.Schemas.Response.Payload",
    OccupationAPISpecs.Occupation.Parent.PATCH.Schemas.Response.Payload
  );
});

describe("Test objects against the OccupationAPISpecs.Occupation.Parent.PATCH.Schemas.Response.Payload schema", () => {
  const givenParent = {
    id: getMockId(1),
    UUID: randomUUID(),
