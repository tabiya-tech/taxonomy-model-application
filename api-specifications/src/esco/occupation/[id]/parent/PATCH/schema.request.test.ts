...
describe("OccupationAPISpecs.Occupation.Parent.PATCH.Schemas.Request.Payload schema", () => {
  testValidSchema(
...
describe("Test objects against the OccupationAPISpecs.Occupation.Parent.PATCH.Schemas.Request.Payload schema", () => {
  const validPayload = {
    id: getMockId(1),
  ...
  describe("OccupationAPISpecs.Occupation.Parent.PATCH.Schemas.Request.Payload fields", () => {
