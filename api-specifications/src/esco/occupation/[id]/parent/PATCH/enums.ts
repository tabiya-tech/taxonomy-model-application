namespace PATCHOccupationParentErrors {
  ...
  export namespace Status500 {
    export enum ErrorCodes {
      DB_FAILED_TO_UPDATE_OCCUPATION_PARENT = "DB_FAILED_TO_UPDATE_OCCUPATION_PARENT",
    }
  }
}

export default PATCHOccupationParentErrors;
