...
describe("Test Occupation Parent Response Schema Validity", () => {
  // WHEN the OccupationAPISpecs.Detail.parent.GET.Schemas.Response.Payload schema
...
describe("Test objects against the OccupationAPISpecs.Detail.parent.GET.Schemas.Response.Payload schema", () => {
  ...
  describe("Validate OccupationAPISpecs.Detail.parent.GET.Schemas.Response.Payload fields", () => {
    ...
    describe("Test validation of parent fields", () => {
      ...
      describe("Test validation of 'parent/id'", () => {
        ...
        test.each(testCases)(
          ...
          (caseType, _description, givenValue, failureMessages) => {
            ...
            assertCaseForProperty("/parent/id", givenObject, parentSchema, caseType, failureMessages);
          }
        );
      });
      ...
      describe("Test validation of 'parent/UUID'", () => {
        ...
        test.each(testCases)(
          ...
          (caseType, _description, givenValue, failureMessages) => {
            ...
            assertCaseForProperty("/parent/UUID", givenObject, parentSchema, caseType, failureMessages);
          }
        );
      });
      ...
      describe("Test validation of 'parent/code'", () => {
        test.each([
          ...
          (caseType, _description, givenValue, objectType, failureMessage) => {
            ...
            assertCaseForProperty("/parent/code", givenObject, parentSchema, caseType, failureMessage);
          }
        );
      });
      ...
      describe("Test validation of 'parent/occupationGroupCode'", () => {
        test.each([
          ...
          (caseType, _description, givenValue, objectType, failureMessage) => {
            ...
            assertCaseForProperty("/parent/occupationGroupCode", givenObject, parentSchema, caseType, failureMessage);
          }
        );
      });
      ...
      describe("Test validation of 'parent/preferredLabel'", () => {
        ...
        test.each(testCases)(
          ...
          (caseType, _description, givenValue, failureMessage) => {
            ...
            assertCaseForProperty("/parent/preferredLabel", givenObject, parentSchema, caseType, failureMessage);
          }
        );
      });
      ...
      describe("Test validation of 'parent/objectType'", () => {
        test.each([
          ...
          assertCaseForProperty("/parent/objectType", givenObject, parentSchema, caseType, failureMessage);
        });
      });
    });
    ...
    describe("Test validation of 'children'", () => {
      test.each([
        ...
        assertCaseForProperty("children", givenObject, occupationSchema, caseType, failureMessages);
      });
    });
  });
});
