...
describe("OccupationAPISpecs.Occupation.Skills.PATCH.Schemas.Response.Payload schema", () => {
  testValidSchema(
    "OccupationAPISpecs.Occupation.Skills.PATCH.Schemas.Response.Payload",
    OccupationAPISpecs.Occupation.Skills.PATCH.Schemas.Response.Payload
  );
});

describe("Test objects against the OccupationAPISpecs.Occupation.Skills.PATCH.Schemas.Response.Payload schema", () => {
  const givenParent = {
    id: getMockId(2),
    UUID: randomUUID(),
  ...
  describe("OccupationAPISpecs.Occupation.Skills.PATCH.Schemas.Response.Payload fields", () => {
    const itemSchema = OccupationAPISpecs.Occupation.Skills.PATCH.Schemas.Response.Payload;
