...
describe("OccupationAPISpecs.Occupation.Skills.PATCH.Schemas.Request.Payload schema", () => {
  testValidSchema(
...
describe("Test objects against the OccupationAPISpecs.Occupation.Skills.PATCH.Schemas.Request.Payload schema", () => {
  const validPayload = {
  ...
  describe("OccupationAPISpecs.Occupation.Skills.PATCH.Schemas.Request.Payload fields", () => {
