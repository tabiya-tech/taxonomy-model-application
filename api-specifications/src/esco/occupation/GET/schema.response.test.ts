...
describe("Test Occupation Schema Validity", () => {
  // WHEN the OccupationAPISpecs.GETOccupations.Schemas.Response.Payload schema
...
describe("Test objects against the OccupationAPISpecs.GETOccupations.Schemas.Response.Payload schema", () => {
