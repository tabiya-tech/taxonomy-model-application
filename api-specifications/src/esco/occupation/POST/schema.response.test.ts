...
describe("Test OccupationAPISpecs schema validity", () => {
  // WHEN the OccupationAPISpecs.POSTOccupation.Schemas.Response.Payload schema
...
describe("Test objects against the OccupationAPISpecs.POSTOccupation.Schemas.Response.Payload schema", () => {
  ...
  describe("Validate OccupationAPISpecs.POSTOccupation.Schemas.Response.Payload fields", () => {
    ...
    describe("Test validation of parent fields", () => {
      ...
      describe("Test validation of '/parent/code'", () => {
        test.each([
          [CaseType.Success, "undefined", undefined, OccupationEnums.Relations.Parent.ObjectTypes.ISCOGroup, undefined],
          [
            CaseType.Failure,
            "null",
            null,
            OccupationEnums.Relations.Parent.ObjectTypes.ISCOGroup,
          ...
          [
            ...
            "empty string",
            "",
            OccupationEnums.Relations.Parent.ObjectTypes.LocalGroup,
            constructSchemaError(
              "/parent/code",
              "pattern",
      ...
      describe("Test validation of '/parent/objectType'", () => {
        test.each([
          ...
          [CaseType.Success, "a valid objectType", OccupationEnums.Relations.Parent.ObjectTypes.ISCOGroup, undefined],
