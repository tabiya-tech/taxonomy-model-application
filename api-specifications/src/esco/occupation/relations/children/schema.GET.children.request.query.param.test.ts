...
describe("Test Occupation Children Request Query Param Schema Validity", () => {
  // WHEN the OccupationAPISpecs.GET.Children.Request.Query.Payload schema
...
describe("Test objects against the OccupationAPISpecs.Schemas.GET.Children.Request.Query.Payload schema", () => {
  const givenSchema = OccupationAPISpecs.Schemas.GET.Children.Request.Query.Payload;
