...
export const ErrorSchema: SchemaObject = {
  ...
  properties: {
    errorCode: {
      ...
      type: "string",
      enum: [Object.values(ErrorConstants.ErrorCodes), Object.values(ImportAPI.Enums.ImportResponseErrorCodes), Object.values(ModelInfoAPI.Enums.POST.Response.ErrorCodes)].flat(),
