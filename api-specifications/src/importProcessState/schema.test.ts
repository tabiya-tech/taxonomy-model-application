...
describe('Test the ImportProcessStateAPISpecs Schema', () => {
  ...
  testValidSchema("ImportProcessStateAPISpecs.Schemas.GET.Response.Payload", ImportProcessStateAPISpecs.Schemas.GET.Response.Payload);
});
...
describe('Validate JSON against the ImportProcessStateAPISpecs Schema', () => {
  ...
  testSchemaWithValidObject("ImportProcessStateAPISpecs.Schemas.GET.Response.Payload", ImportProcessStateAPISpecs.Schemas.GET.Response.Payload, givenValidImportProcessState);

  // AND WHEN the object has additional properties
  // THEN expect the object to not validate
  testSchemaWithInvalidObject("ImportProcessStateAPISpecs.Schemas.GET.Response.Payload", ImportProcessStateAPISpecs.Schemas.GET.Response.Payload, givenValidImportProcessState);
});
