...
describe('Validate JSON against the Info Schema', () => {
    ...
    testSchemaWithValidObject("Info.Schemas.GET.Response.Payload", InfoAPISpecs.Schemas.GET.Response.Payload, givenValidInfoResponse);

    // AND WHEN the object has additional properties
    // THEN expect the object to not validate
    testSchemaWithInvalidObject("Info.Schemas.GET.Response.Payload", InfoAPISpecs.Schemas.GET.Response.Payload, givenValidInfoResponse);
});